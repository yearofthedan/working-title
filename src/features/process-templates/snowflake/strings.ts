export const strings = {
  ...
  step: {
    genre: {
      label: 'Genre',
      instruction: 'Enter the genre of your story.',
      placeholder: 'Science Fiction, Fantasy, Horror, etc.',
    },
    target_audience: {
      label: 'Target Audience',
      instruction: 'Enter the target audience of your story.',
      placeholder: 'Adult, Teen, Children, etc.',
    },
    theme: {
      label: 'Theme',
      instruction: 'Enter an overarching theme of your story.',
      placeholder: 'Are people inherently good or bad?',
    },
    summary: {
      label: 'One Sentence Summary',
      instruction: 'Write a single sentence that summarizes your story. Keep it under 15 words.',
      placeholder: 'A young woman discovers she has the power to change the course of history.',
      actions: {
    ...
    storyline: {
      ...
      instruction:
        'Expand your sentence into a full paragraph describing the setup, major disasters, and ending.',
      placeholder:
    ...
    plot_synopsis: {
      ...
      placeholder:
        'Expand the specific storyline sentence here. Focus on the conflict and the result of that conflict.',
      actions: {
    ...
    major_char: {
      ...
      placeholder:
        "Write the character's full backstory, their role in the story, and how they change over the course of the narrative.",
    },
    minor_char: {
      label: 'Minor Character Profile',
      instruction: "Write a brief summary of the character's role and personality.",
      placeholder:
        'Brief description of role, personality tags, and how they support the protagonist.',
    },
    detailed_synopsis: {
      label: 'Detailed Synopsis',
      instruction: 'Expand the plot synopsis paragraph into a full page description.',
      placeholder:
        'Detail the events of this section. Who is present? What is said? What is the setting?',
      actions: {
  ...
  validation: {
    detailed_synopsis: {
      missing_major_char:
        'A detailed synopsis requires a Major Character perspective to be complete.',
    },
  },
}
